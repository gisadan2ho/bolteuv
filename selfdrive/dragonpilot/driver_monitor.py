...
_AWARENESS_TIME = 30000.  # 30 secs limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 15000.  # a first alert is issued 15s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 6000.  # a second alert is issued 6s before start decelerating the car
